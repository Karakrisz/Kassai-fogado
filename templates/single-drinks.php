<section class="food_options text-center">
    <div class="container">
        ...
        <form method="POST" method="post" action="/drinks<?php esc($drinks["id"])?>/edit" enctype="multipart/form-data">
            <div class="row d-flex justify-content-around">
                <div class="col-xl-6 form-group">
                    <label for="Daily-offer">Étel neve</label>
                    <input name="drinks_name" id="drinks_name" value="<?php esc($drinks["drinks_name"])?>"
                        class="form-control" required />

                    <label for="Étel jellemzése">Étel jellemzése</label>
                    <input name="drinks_characterization" id="drinks_characterization"
                        value="<?php esc($drinks["drinks_characterization"])?>" class="form-control" required />

                    <label for="Étel jellemzése">Étel ára</label>
                    <input name="drinks_price" id="drinks_price" value="<?php esc($drinks["drinks_price"])?>"
                        class="form-control" required />
                </div>
            </div>
