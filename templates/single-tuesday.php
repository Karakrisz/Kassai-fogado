<section class="food_options text-center">
    <div class="container">
        ...
        <form method="POST" method="post" action="/tuesday<?php esc($tuesday["id"])?>/edit"
            enctype="multipart/form-data">
            <div class="row d-flex justify-content-around">
                <div class="col-xl-6 form-group">
                    <label for="Daily-offer">Étel neve</label>
                    <input name="tuesday_name" id="tuesday_name" value="<?php esc($tuesday["tuesday_name"])?>"
                        class="form-control" required />

                    <label for="Étel jellemzése">Étel jellemzése</label>
                    <input name="tuesday_characterization" id="tuesday_characterization"
                        value="<?php esc($tuesday["tuesday_characterization"])?>" class="form-control" required />
                </div>
            </div>
